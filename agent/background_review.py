...
_SKILL_REVIEW_PROMPT = (
    "Review the conversation above and stay ACTIVE about the skill "
    "library: update it ONLY when a genuinely novel, transferable, "
    "cross-session lesson emerged, but treat inaction as a missed "
    "opportunity when a durable lesson is present. Most routine cron "
    "ticks produce NOTHING worth saving — 'Nothing to save.' is the "
    "correct and common outcome. Do not manufacture an update to feel "
    "productive.\n\n"
...
_COMBINED_REVIEW_PROMPT = (
    "Review the conversation above and stay ACTIVE about two things:\n\n"
    ...
    "nothing and 'Nothing to save.' is correct, but treat that as a "
    "missed opportunity when a durable lesson is present. ⚠️ SIZE "
    "DISCIPLINE: SKILL.md bodies have a 100,000-char hard limit "
    "(saves rejected past it). Never append to a SKILL.md already "
    ">50KB — use `references/` + a one-line pointer. Never write dated "
    "per-tick status/confirmation notes to the skill library; those go "
    "to memory or the brain.\n\n"
